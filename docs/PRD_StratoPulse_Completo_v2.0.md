...
| SP-NT02 | AlertRecord: geração de alertas por categoria (financeiro, otimização, governança, atividade) | P1 | Regras configuráveis por categoria (✅ GET/PUT `/notifications/rules/{category}`) e geração integrada em fluxos de activity, economics, opportunities e risk budgets | SP-NT01 |
...
| 11 | SP-NT02 | AlertRecord por categoria (✅ regras configuráveis e geração multi-categoria) | P1 |
